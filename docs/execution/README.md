...
| [03 — Extra coverage](phase-03-extra-coverage.md)                         | Complete    | Phase 02 merged and stable              | Demonstrate framework reuse through complementary coverage and a focused PR     |
